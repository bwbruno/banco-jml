...
Etant donné que le service ExchangeService est initialisé avec le taxa du jour 0.82 pour EUR-CHF
...
Etant donné que le service ExchangeServiceCHF-EUR est initialisé avec le taxa du jour 0.82 pour EUR-CHF
Etant donné que le service ExchangeServiceGBP-EURr est initialisé avec le taxa du jour 1.26 pour EUR-GBP
Quand le porteur effectue un paiement chez un commerçant de 100 CHF
